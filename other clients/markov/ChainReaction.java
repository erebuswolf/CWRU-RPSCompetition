...
public class ChainReaction extends Client {
	...
	protected RPSThrow pickThrow(double rockOdds, double paperOdds, double scissorOdds){
		...
		if(rockOdds > paperOdds && rockOdds > scissorOdds)
			return RPSThrow.paper;
		else if(paperOdds > rockOdds && paperOdds > scissorOdds)
	...
	public ChainReaction(int securePort) {
		super(securePort);
	...
	public static void main(String[] args) {
		...
		ChainReaction client=new ChainReaction(secure_port);
		client.playGame();
	}
