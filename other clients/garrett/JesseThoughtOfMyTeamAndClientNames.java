...
public class JesseThoughtOfMyTeamAndClientNames extends Client {
   ...
   private void chooseStrategy()
   {
      ...
      if ( num_paper >= num_rock )
      {
         if ( num_paper >= num_scissors )
            strategy = 1;
         else
            strategy = 3;
      }
   ...
   public JesseThoughtOfMyTeamAndClientNames(int securePort) {
      super(securePort);
      this.name="JesseThoughtOfMyTeamAndClientNames";
   }
   ...
   public static void main(String[] args){
      ...
      JesseThoughtOfMyTeamAndClientNames client = new JesseThoughtOfMyTeamAndClientNames(secure_port);
      client.setUp(); //Check *** 
      client.playGame();
   }
