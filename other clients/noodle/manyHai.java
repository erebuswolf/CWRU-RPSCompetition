...
public class manyHai extends Client {
	...
	public manyHai(int securePort) {
		super(securePort);
		this.name="¿Can has cheesebürger con tocino, many plz?";
	...
	public static void main(String[] args) {
		...
		manyHai client=new manyHai(secure_port);
		client.playGame();
	}
