...
public class moe extends Client {
	...
	public static void main(String[] args) {
		if(args.length<1){
			System.out.println("error useage: moe port");
		}
		int secure_port=Integer.parseInt(args[0]);

		moe client=new moe(secure_port);
		client.playGame();
	}
    ...
    private void zap(int t) throws IOException {
        ...
        System.out.println("moe confused");
    }
